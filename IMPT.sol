...
contract BEP20Token is BEP20("IMPT", "IMPT", 18) {
    struct Presale {
    ...
    */
    ...
    constructor() {
        ...
        */
        ...
        presales[0] = Presale(8, 20, false, 0, 0, 0xa53FfBdfC9A58f192b6569744c88386b094B0767, 10000000);
        presales[1] = Presale(8, 20, false, 0, 0, 0x12D78b3084a2a7E55E549260a38bD762CfD374cc, 10000000);
        presales[2] = Presale(9, 20, false, 0, 0, 0x344519a1767f16Dd3bF2D1d0793358a6bbCe1013, 10000000);
        ...
        */
        ...
        privatesales[0] = Privatesale(10, 30, false, 0, 0, 0xa53FfBdfC9A58f192b6569744c88386b094B0767, 10000000);
        ...
        *--------------------------------------------
        */
        public_sale[0] = PublicSale(8, 0x4Dc817014E1c8E99bEb3eBAb3DeeA6567151a47C);
        public_sale[1] = PublicSale(8, 0x795C9B4870C215ae7a61a906cf3B57C3fB4B2C5d);
        public_sale[2] = PublicSale(9, 0x55F610b326c5Bc918C3C02F2dc3B3EFd2fFA5008);
